...
export default async function Hero() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-73px)] flex items-center justify-center py-16 sm:py-20 lg:py-24 overflow-hidden">
      {/* Radial gradient depth - subtle glow behind content */}
      ...
      {/* Content container - NO glass card, content floats on grid */}
      <div className="relative w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 sm:space-y-8">
        {/* Headline */}
        ...
        {/* Feature bullets - small glass cards OK */}
